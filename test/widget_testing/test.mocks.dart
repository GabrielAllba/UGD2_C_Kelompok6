...
// in ugd2_c_kelompok6/test/login_test.dart.
...
import 'package:ugd2_c_kelompok6/client/AuthClient.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthClient extends _i1.Mock implements _i7.AuthClient {
  MockAuthClient() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<_i2.Response> loginTesting(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
